  ...
  return (
    <aside className="dashboard-sidebar" id="sidebar">
      ...
      <img
        ...
        />
        <h2 className="app-logo">Style Heaven</h2>
      </div>
            ...
            <>
              ...
              <li>
                <a
                  ...
                  className={`nav-link ${isActive("/dashboard/vendor-management")}`}
                >
                  Vendor Management
                </a>
              </li>
              <li>
                <a
                  href="/dashboard/orderHomePage"
                  className={`nav-link ${isActive("/dashboard/orderHomePage")}`}
                >
                  Order Management
                </a>
              </li>
              <li>
                <a
                  ...
                  className={`nav-link ${isActive("/dashboard/customer-management")}`}
                >
                  Customer Management
                </a>
              </li>
