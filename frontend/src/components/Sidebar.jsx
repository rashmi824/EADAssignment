    ...
    <aside className="dashboard-sidebar" id="sidebar">
      ...
      <nav className="sidebar-navigation">
        <ul className="nav-list">
          ...
          {role === 'Administrator' && (
            <>
              <li><a href="/dashboard/product-management" className="nav-link">Product Activation/Deactivation</a></li>
              <li><a href="/dashboard/inventory-management" className="nav-link">Inventory Management</a></li>
              <li><a href="/dashboard/vendor-management" className="nav-link">Vendor Management</a></li>
              <li><a href="/dashboard/order" className="nav-link">Order Status</a></li>
              <li><a href="/dashboard/customer-management" className="nav-link">Customer Management</a></li>
            </>
          )}
          {role === 'Vendor' && (
            <>
              <li><a href="/dashboard/product-management" className="nav-link">Product CRUD</a></li>
              <li><a href="/dashboard/order-status" className="nav-link">Order Status</a></li>
            </>
          )}
          {role === 'CSR' && (
            <>
